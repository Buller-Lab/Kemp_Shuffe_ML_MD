...
additional_residue_definitions_file = "additional_residues.xml"

protonation_dict = {}

sim_ph = 7
sim_temperature = 308.15
trajectory_out_atoms = 'protein or resname H5J'
trajectory_out_interval = 500
restrained_eq_atoms = 'protein and name CA or resname H5J or chainid 1'
