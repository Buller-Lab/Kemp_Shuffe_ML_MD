import pandas as pd
from angle.angle import measure_angle
import warnings
...
atom1="protein and resid 123 and name OD1"
atom1_alt="protein and resid 123 and name OD2"
atom2="resname H5J and name H03"        
atom3="protein and resid 123 and name CG"
...
header = pd.DataFrame([["Variant","Trajectory","Chain","Angle"]])
...
for variant in variant_list:
    ...
    for residue in residue_list:
        for chain in chain_list:
            measure_angle(path, pre, ext, variant, atom1, atom1_alt, atom2, atom3, chain, out, sep)
