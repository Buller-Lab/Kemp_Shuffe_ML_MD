import pandas as pd
from dist.dist import measure_distance
import warnings
...
# definition of path to variant trajectories (needs to be adapted)
...
# atoms to measure distance
    
atom1="resn H5J and name OAA"#"protein and resid 233 and name H"#"protein and resid 123 and name OD1"
atom1_alt="resn H5J and name OAB"#"protein and resid 123 and name OD2"
atom2="protein and resid 233 and name H"        

# list of residue strings in the following format: "RES 123"
residue_list = ["MET 237"]
...
header = pd.DataFrame([["Variant","Trajectory","Chain","Distance"]])
...
for variant in variant_list:
    ...
    for residue in residue_list:
        for chain in chain_list:
            measure_distance(path, pre, ext, variant, atom1, atom1_alt, atom2, chain, out, sep)
