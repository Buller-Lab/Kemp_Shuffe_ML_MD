...
traj_folder = 'trajectories_HT_MD_R3'
...
# mutations
mutation_list = [('A', 'LYS-50-GLN'),('A', 'MET-172-ALA'),('A', 'GLN-90-HIS'),('A', 'GLN-207-MET'),('A', 'MET-49-LEU'),('A', 'THR-54-ILE'),('A', 'ASN-102-GLU'),('A', 'GLU-131-SER'),('A', 'PRO-154-LYS'),('A', 'ARG-190-LYS')]#('A', 'ASN-290-GLN'), ('A', 'THR-282-SER')]
