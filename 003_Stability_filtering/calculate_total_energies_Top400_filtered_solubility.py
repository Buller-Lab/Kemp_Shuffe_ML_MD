...
if __name__ == "__main__":
    input_folder = "minimized_Top400_filtered_solubility_structures"
    output_folder = "processed_Top400_filtered_solubility_structures"
    output_csv = "total_energies_Top400.csv"
    process_pdb_files(input_folder, output_folder, output_csv)
    stability_df = pd.read_csv("total_energies_Top400.csv")
    variants_df = pd.read_csv("Top400_filtered_solubility.csv",sep=";")
    ...
    merged_df.to_csv("total_energies_Top400_filtered_solubility.csv", sep=";",index=False)
